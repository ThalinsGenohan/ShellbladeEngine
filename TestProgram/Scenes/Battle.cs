...
namespace OtterRPG.Scenes
{
	internal class Battle : Scene
	{
		...
		{
			AttackButton = new Button(new Vector2i(16, 16), new Texture(@"assets/temp-icons.png", new IntRect(0, 0, 16, 16)), game)
			{
			...
			SkillsButton = new Button(new Vector2i(16, 16), new Texture(@"assets/temp-icons.png", new IntRect(16, 0, 16, 16)), game)
			{
				Color         = new Color(0xffffff7f),
			...
			MagicButton = new Button(new Vector2i(16, 16), new Texture(@"assets/temp-icons.png", new IntRect(32, 0, 16, 16)), game)
			{
				Color         = new Color(0xffffff7f),
			...
			ItemButton = new Button(new Vector2i(16, 16), new Texture(@"assets/temp-icons.png", new IntRect(48, 0, 16, 16)), game)
			{
				Color         = new Color(0xffffff7f),
